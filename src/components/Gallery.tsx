...
const photos = [
  { src: '/gallery/akershus-fortress (1).jpg', alt: 'Akershus Fortress exterior view' },
  { src: '/gallery/akershus-fortress (2).jpg', alt: 'Fortress walls and towers' },
  { src: '/gallery/akershus-fortress (3).jpg', alt: 'Castle courtyard' },
  { src: '/gallery/akershus-fortress (4).jpg', alt: 'Medieval architecture details' },
  { src: '/gallery/akershus-fortress (5).jpg', alt: 'Fortress interior' },
  { src: '/gallery/akershus-fortress (6).jpg', alt: 'View from the fortress' },
  { src: '/gallery/akershus-fortress (7).jpg', alt: 'Historic cannons' },
  { src: '/gallery/akershus-fortress (8).jpg', alt: 'Fortress gate entrance' },
  { src: '/gallery/akershus-fortress (9).jpg', alt: 'Royal mausoleum' },
  { src: '/gallery/akershus-fortress (10).jpg', alt: 'Fortress chapel' },
  { src: '/gallery/akershus-fortress (11).jpg', alt: 'Panoramic Oslo view' },
  { src: '/gallery/akershus-fortress (12).jpg', alt: 'Fortress gardens' },
  { src: '/gallery/akershus-fortress (13).jpg', alt: 'Evening at the fortress' },
  { src: '/gallery/akershus-fortress (14).jpg', alt: 'Fortress sunset view' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-6 gap-4 items-center">
              <a
                href="https://maps.app.goo.gl/2Pie5n149RhyrTd69"
                target="_blank"
